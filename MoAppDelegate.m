...
/*
  ...
  */  
   //[context save:&error];
    ...
    //for(id lorem in data){
    //    NSLog(@"Ligne = %@",[lorem valueForKey:@"name"]);
    //}
//    for(Ligne * Ligne in data){
 //       NSLog(@"Ligne = %@",[Ligne valueForKey:@"name"]);
 //   }
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"rapt2" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"rapt2.sqlite"];
